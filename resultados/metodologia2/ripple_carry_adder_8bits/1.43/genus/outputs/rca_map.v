...
// Generated on: Apr  7 2025 14:33:26 -03 (Apr  7 2025 17:33:26 UTC)
...
module full_adder(A, B, Cin, S, Cout);
  ...
  wire A, B, Cin;
  wire S, Cout;
  wire n_0, n_1, n_2, n_5, n_6, n_12, n_13, n_14;
  wire n_16, n_17, n_18;
  sky130_fd_sc_hd__o21ai_2 g192__2398(.A1 (n_2), .A2 (n_6), .B1 (n_1),
       .Y (Cout));
  sky130_fd_sc_hd__mux2_2 g193__5107(.A0 (n_5), .A1 (n_2), .S (n_0), .X
       (S));
  sky130_fd_sc_hd__nor2_4 g196__6260(.A (n_17), .B (n_13), .Y (n_6));
  sky130_fd_sc_hd__inv_1 g199(.A (n_2), .Y (n_5));
  sky130_fd_sc_hd__clkinv_1 g200(.A (Cin), .Y (n_2));
  sky130_fd_sc_hd__or2_4 g2__4319(.A (n_18), .B (n_14), .X (n_1));
  sky130_fd_sc_hd__xnor2_1 g204__8428(.A (n_16), .B (n_12), .Y (n_0));
  sky130_fd_sc_hd__inv_1 fopt(.A (n_13), .Y (n_12));
  sky130_fd_sc_hd__buf_6 fopt205(.A (A), .X (n_13));
  sky130_fd_sc_hd__inv_2 fopt206(.A (A), .Y (n_14));
  sky130_fd_sc_hd__buf_2 fopt207(.A (n_17), .X (n_16));
  sky130_fd_sc_hd__buf_8 fopt208(.A (B), .X (n_17));
  sky130_fd_sc_hd__inv_2 fopt209(.A (B), .Y (n_18));
endmodule
...
module full_adder_21(A, B, Cin, S, Cout);
  ...
  wire n_13;
  sky130_fd_sc_hd__nand2_2 g119__5526(.A (n_8), .B (n_6), .Y (Cout));
  sky130_fd_sc_hd__nand2_2 g121__6783(.A (Cin), .B (n_7), .Y (n_8));
  sky130_fd_sc_hd__nand2_1 g122__3680(.A (n_4), .B (n_3), .Y (n_7));
  sky130_fd_sc_hd__nand2_1 g123__1617(.A (n_0), .B (n_1), .Y (n_6));
...
module full_adder_20(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g121__5122(.A (Cin), .B (n_0), .Y (n_5));
  sky130_fd_sc_hd__nand2_1 g123__8246(.A (B), .B (A), .Y (n_4));
  ...
  sky130_fd_sc_hd__fahcon_1 g130__6131(.A (n_1), .B (n_2), .CI (n_3),
       .COUT_N (UNCONNECTED0), .SUM (S));
endmodule
...
module full_adder_18(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g116__9315(.A (n_5), .B (n_3), .Y (Cout));
  sky130_fd_sc_hd__xor3_2 g117__9945(.A (n_0), .B (n_1), .C (n_11), .X
       (S));
  sky130_fd_sc_hd__nand2_2 g118__2883(.A (Cin), .B (n_4), .Y (n_5));
  sky130_fd_sc_hd__or2_0 g119__2346(.A (B), .B (A), .X (n_4));
  sky130_fd_sc_hd__nand2_1 g120__1666(.A (n_0), .B (n_1), .Y (n_3));
...
module full_adder_17(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g116__7410(.A (n_4), .B (n_2), .Y (Cout));
  sky130_fd_sc_hd__xor3_2 g117__6417(.A (n_0), .B (n_1), .C (n_10), .X
       (S));
  sky130_fd_sc_hd__nand2_2 g118__5477(.A (Cin), .B (n_3), .Y (n_4));
  sky130_fd_sc_hd__or2_0 g119__2398(.A (B), .B (A), .X (n_3));
  sky130_fd_sc_hd__nand2_1 g120__5107(.A (n_0), .B (n_1), .Y (n_2));
...
module full_adder_16(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__a2bb2o_4 g118__4319(.A1_N (n_0), .A2_N (n_2), .B1
       (n_0), .B2 (n_2), .X (S));
...
module full_adder_15(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_0 g84__5122(.A (n_2), .B (n_1), .X (n_4));
  sky130_fd_sc_hd__nand2_1 g85__8246(.A (n_1), .B (n_2), .Y (n_3));
  sky130_fd_sc_hd__clkbuf_1 g87(.A (A), .X (n_2));
  sky130_fd_sc_hd__clkbuf_1 g89(.A (B), .X (n_1));
