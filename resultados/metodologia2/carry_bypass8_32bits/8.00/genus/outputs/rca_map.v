...
module full_adder(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__clkinv_2 g74(.A (A), .Y (n_3));
...
module bypass8(A, B, Cin, S, Cout);
  ...
  full_adder_91 FA7(.A (A[6]), .B (B[6]), .Cin (C[5]), .S (S[6]), .Cout
       (C[6]));
  full_adder_90 FA8(.A (n_16), .B (n_12), .Cin (C[6]), .S (S[7]), .Cout
       (C[7]));
  sky130_fd_sc_hd__clkinv_1 g173(.A (C[7]), .Y (n_26));
  sky130_fd_sc_hd__clkbuf_1 g181(.A (A[3]), .X (n_25));
  sky130_fd_sc_hd__clkbuf_1 g182(.A (A[2]), .X (n_24));
  sky130_fd_sc_hd__clkbuf_1 g184(.A (A[1]), .X (n_23));
  sky130_fd_sc_hd__clkbuf_1 g185(.A (B[1]), .X (n_22));
  sky130_fd_sc_hd__clkbuf_1 g183(.A (B[2]), .X (n_21));
  sky130_fd_sc_hd__clkbuf_1 g186(.A (A[0]), .X (n_20));
  sky130_fd_sc_hd__clkbuf_1 g187(.A (B[0]), .X (n_19));
  sky130_fd_sc_hd__clkbuf_1 g176(.A (A[5]), .X (n_18));
  sky130_fd_sc_hd__clkbuf_1 g178(.A (A[4]), .X (n_17));
  sky130_fd_sc_hd__clkbuf_1 g175(.A (A[7]), .X (n_16));
  sky130_fd_sc_hd__clkbuf_1 g177(.A (B[5]), .X (n_15));
  sky130_fd_sc_hd__clkbuf_1 g180(.A (B[3]), .X (n_14));
  sky130_fd_sc_hd__clkbuf_1 g179(.A (B[4]), .X (n_13));
  sky130_fd_sc_hd__clkbuf_1 g174(.A (B[7]), .X (n_12));
  ...
  sky130_fd_sc_hd__nand4_1 g264__7482(.A (n_0), .B (n_1), .C (n_4), .D
       (n_6), .Y (n_8));
  sky130_fd_sc_hd__xor2_1 g265__4733(.A (n_13), .B (n_17), .X (n_7));
  sky130_fd_sc_hd__xor2_1 g266__6161(.A (n_21), .B (n_24), .X (n_6));
  sky130_fd_sc_hd__xor2_1 g267__9315(.A (B[6]), .B (A[6]), .X (n_5));
  sky130_fd_sc_hd__xor2_1 g268__9945(.A (n_22), .B (n_23), .X (n_4));
  sky130_fd_sc_hd__xor2_1 g269__2883(.A (B[7]), .B (A[7]), .X (n_3));
  sky130_fd_sc_hd__xor2_1 g270__2346(.A (n_15), .B (n_18), .X (n_2));
  sky130_fd_sc_hd__xor2_1 g271__1666(.A (n_19), .B (n_20), .X (n_1));
  sky130_fd_sc_hd__xor2_1 g272__7410(.A (n_14), .B (n_25), .X (n_0));
endmodule
...
module full_adder_87(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__xor2_1 g58__1705(.A (n_5), .B (n_0), .X (S));
  sky130_fd_sc_hd__nand2_1 g59__5122(.A (Cin), .B (n_4), .Y (n_6));
  sky130_fd_sc_hd__xor2_1 g60__8246(.A (n_1), .B (n_2), .X (n_5));
  sky130_fd_sc_hd__or2_0 g61__7098(.A (A), .B (B), .X (n_4));
  sky130_fd_sc_hd__nand2_1 g62__6131(.A (n_1), .B (n_2), .Y (n_3));
...
module full_adder_79(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__xor2_1 g58__5526(.A (n_3), .B (n_0), .X (S));
...
module carry_bypass8_32bits(A, B, Cin, S, Cout);
  ...
  wire n_72;
  bypass8 BPS1(.A ({n_57, n_45, n_52, n_51, n_67, n_71, n_69, n_68}),
       .B ({n_0, n_62, n_59, n_56, n_55, n_65, n_72, n_70}), .Cin
       (n_66), .S (S[7:0]), .Cout (C[0]));
  bypass8_7 \bypass_loop[1].BPS2 (.A ({n_20, n_21, n_13, n_11, n_7,
       n_37, n_1, n_61}), .B ({n_38, n_10, n_8, n_6, n_5, n_12, n_39,
       n_27}), .Cin (C[0]), .S (S[15:8]), .Cout (C[1]));
  bypass8_6 \bypass_loop[2].BPS2 (.A ({n_54, n_50, n_46, n_63, n_41,
       n_44, n_30, n_53}), .B ({n_26, n_24, n_22, n_28, n_19, n_17,
       n_15, n_36}), .Cin (C[1]), .S (S[23:16]), .Cout (C[2]));
  bypass8_5 \bypass_loop[3].BPS2 (.A ({n_58, n_43, n_34, n_25, n_18,
       n_14, n_4, n_48}), .B ({n_49, n_64, n_42, n_40, n_35, n_33,
       n_31, n_29}), .Cin (C[2]), .S (S[31:24]), .Cout (Cout));
  sky130_fd_sc_hd__inv_2 g37(.A (n_9), .Y (n_72));
  sky130_fd_sc_hd__inv_2 g22(.A (n_23), .Y (n_71));
  ...
  sky130_fd_sc_hd__inv_2 g59(.A (n_32), .Y (n_65));
  sky130_fd_sc_hd__clkbuf_1 g49(.A (B[30]), .X (n_64));
  sky130_fd_sc_hd__clkbuf_1 g6(.A (A[20]), .X (n_63));
  ...
  sky130_fd_sc_hd__clkbuf_1 g4(.A (A[31]), .X (n_58));
  ...
  sky130_fd_sc_hd__clkbuf_1 g57(.A (A[16]), .X (n_53));
  sky130_fd_sc_hd__clkbuf_1 g5(.A (A[5]), .X (n_52));
  sky130_fd_sc_hd__clkbuf_1 g68(.A (A[4]), .X (n_51));
  sky130_fd_sc_hd__clkbuf_1 g34(.A (A[22]), .X (n_50));
  sky130_fd_sc_hd__clkbuf_1 g61(.A (B[31]), .X (n_49));
  sky130_fd_sc_hd__clkbuf_1 g45(.A (A[24]), .X (n_48));
  sky130_fd_sc_hd__clkinv_1 g29(.A (A[3]), .Y (n_47));
  sky130_fd_sc_hd__clkbuf_1 g1(.A (A[21]), .X (n_46));
  sky130_fd_sc_hd__clkbuf_1 g35(.A (A[6]), .X (n_45));
  sky130_fd_sc_hd__clkbuf_1 g52(.A (A[18]), .X (n_44));
  sky130_fd_sc_hd__clkbuf_1 g27(.A (A[30]), .X (n_43));
  ...
  sky130_fd_sc_hd__clkbuf_1 g46(.A (B[16]), .X (n_36));
  ...
  sky130_fd_sc_hd__clkinv_1 g60(.A (B[2]), .Y (n_32));
  ...
  sky130_fd_sc_hd__clkbuf_1 g44(.A (B[20]), .X (n_28));
  ...
  sky130_fd_sc_hd__clkbuf_1 g19(.A (B[22]), .X (n_24));
  sky130_fd_sc_hd__clkinv_1 g23(.A (A[2]), .Y (n_23));
  ...
  sky130_fd_sc_hd__clkbuf_1 g58(.A (A[11]), .X (n_7));
  sky130_fd_sc_hd__clkbuf_1 g62(.A (B[12]), .X (n_6));
  sky130_fd_sc_hd__clkbuf_1 g69(.A (B[11]), .X (n_5));
