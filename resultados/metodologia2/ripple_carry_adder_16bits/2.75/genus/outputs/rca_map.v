...
// Generated on: Apr  7 2025 14:21:00 -03 (Apr  7 2025 17:21:00 UTC)
...
module full_adder_15_21(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g59__8246(.A (Cin), .B (n_3), .Y (n_5));
...
module full_adder_15_24(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g61__4319(.A (n_1), .B (n_2), .Y (n_3));
  sky130_fd_sc_hd__buf_1 g62(.A (A), .X (n_2));
  sky130_fd_sc_hd__buf_1 g63(.A (B), .X (n_1));
  sky130_fd_sc_hd__fa_1 g65__8428(.A (n_1), .B (n_2), .CIN (Cin), .COUT
       (UNCONNECTED), .SUM (S));
endmodule
...
module full_adder_15_25(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g61__1617(.A (n_1), .B (n_2), .Y (n_3));
  sky130_fd_sc_hd__buf_1 g62(.A (A), .X (n_2));
  sky130_fd_sc_hd__buf_1 g63(.A (B), .X (n_1));
  sky130_fd_sc_hd__fa_1 g65__2802(.A (n_1), .B (n_2), .CIN (Cin), .COUT
       (UNCONNECTED0), .SUM (S));
endmodule
...
module full_adder_15(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2b_4 g2__5477(.A_N (n_3), .B (n_1), .Y (Cout));
  sky130_fd_sc_hd__nand2_1 g3__2398(.A (Cin), .B (n_2), .Y (n_1));
endmodule
...
module ripple_carry_adder_16bits(A, B, S, Cout);
  ...
  full_adder F1A(.A (n_22), .B (n_28), .Cin (1'b0), .S (S[0]), .Cout
       (carry[0]));
  full_adder_15_15 \full_adder_loop[1].FA (.A (n_26), .B (n_30), .Cin
  ...
  sky130_fd_sc_hd__clkbuf_1 g31(.A (B[13]), .X (n_31));
  sky130_fd_sc_hd__buf_1 g20(.A (B[1]), .X (n_30));
  ...
  sky130_fd_sc_hd__clkbuf_1 g19(.A (A[1]), .X (n_26));
  sky130_fd_sc_hd__inv_2 g25(.A (A[4]), .Y (n_25));
  sky130_fd_sc_hd__clkbuf_1 g23(.A (B[11]), .X (n_24));
  sky130_fd_sc_hd__clkbuf_1 g13(.A (A[10]), .X (n_23));
  ...
  sky130_fd_sc_hd__clkbuf_1 g17(.A (B[15]), .X (n_19));
  sky130_fd_sc_hd__clkinv_1 g7(.A (B[4]), .Y (n_18));
  sky130_fd_sc_hd__clkbuf_1 g1(.A (A[14]), .X (n_17));
  sky130_fd_sc_hd__clkbuf_1 g14(.A (A[11]), .X (n_16));
  ...
  sky130_fd_sc_hd__clkbuf_1 g16(.A (A[13]), .X (n_11));
  sky130_fd_sc_hd__clkbuf_1 g22(.A (B[10]), .X (n_10));
