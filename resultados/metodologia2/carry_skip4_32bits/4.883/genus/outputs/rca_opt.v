...
// Generated on: Apr  7 2025 17:24:50 -03 (Apr  7 2025 20:24:50 UTC)
...
module full_adder_99(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g124__7098(.A (Cin), .B (n_16), .Y (n_8));
...
module skip4_104(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_4 g153__1617(.A (n_6), .B (n_4), .Y (n_5));
...
module full_adder_79(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_4 g125__6417(.A (A), .B (B), .X (n_3));
...
module full_adder_71(A, B, Cin, S, Cout);
  ...
  wire A, B, Cin;
  wire S, Cout;
  wire UNCONNECTED6, n_2, n_3, n_4, n_6, n_7, n_17, n_18;
  wire n_20;
  sky130_fd_sc_hd__nand2_4 g123__6260(.A (n_6), .B (n_2), .Y (Cout));
  sky130_fd_sc_hd__nand2_8 g124__4319(.A (n_7), .B (n_20), .Y (S));
  ...
  sky130_fd_sc_hd__ha_1 g129__136(.A (B), .B (A), .COUT (UNCONNECTED6),
       .SUM (n_4));
  sky130_fd_sc_hd__nand2b_2 g2(.A_N (n_4), .B (n_18), .Y (n_20));
endmodule
...
module full_adder_70(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_2 g131__5115(.A (B), .B (A), .Y (n_2));
  sky130_fd_sc_hd__clkinv_1 fopt(.A (Cin), .Y (n_1));
  sky130_fd_sc_hd__nand2b_2 g2__7482(.A_N (n_4), .B (Cin), .Y (n_0));
  sky130_fd_sc_hd__ha_1 g129__134(.A (B), .B (A), .COUT (UNCONNECTED7),
       .SUM (n_4));
endmodule
...
module carry_skip4_32bits(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__buf_6 g15(.A (B[0]), .X (n_58));
  ...
  sky130_fd_sc_hd__clkbuf_1 g27(.A (A[29]), .X (n_47));
  sky130_fd_sc_hd__clkbuf_1 g6(.A (B[5]), .X (n_46));
  sky130_fd_sc_hd__clkbuf_1 g46(.A (B[29]), .X (n_45));
  ...
  sky130_fd_sc_hd__inv_4 g63(.A (Cin), .Y (n_33));
