...
// Generated on: Apr  7 2025 17:26:20 -03 (Apr  7 2025 20:26:20 UTC)
...
module carry_skip4_32bits(A, B, Cin, S, Cout);
  ...
  skip4_107 \skip_loop[1].CSKIP2 (.A ({n_13, n_10, n_6, n_2}), .B
  ...
  skip4_105 \skip_loop[3].CSKIP2 (.A ({n_49, n_43, n_53, n_33}), .B
       ...
       (C[3]));
  skip4_104 \skip_loop[4].CSKIP2 (.A ({n_3, n_63, n_55, n_52}), .B
  ...
  sky130_fd_sc_hd__clkbuf_1 g32(.A (A[18]), .X (n_63));
  ...
  sky130_fd_sc_hd__inv_6 g62(.A (Cin), .Y (n_23));
  ...
  sky130_fd_sc_hd__clkbuf_1 g35(.A (A[7]), .X (n_13));
