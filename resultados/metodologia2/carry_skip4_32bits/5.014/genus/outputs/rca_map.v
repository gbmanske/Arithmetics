...
// Generated on: Apr  7 2025 17:27:57 -03 (Apr  7 2025 20:27:57 UTC)
...
module full_adder(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nor2_4 g194__4319(.A (B), .B (A), .Y (n_2));
...
module full_adder_98(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g122__7482(.A (n_4), .B (n_2), .Y (Cout));
  ...
  sky130_fd_sc_hd__clkbuf_1 g128(.A (Cin), .X (n_1));
...
module skip4(A, B, Cin, S, Cout);
  ...
  full_adder_98 FA4(.A (A[3]), .B (B[3]), .Cin (C[2]), .S (S[3]), .Cout
       (C[3]));
  sky130_fd_sc_hd__clkinv_1 g74(.A (C[3]), .Y (n_9));
  sky130_fd_sc_hd__clkbuf_1 g77(.A (Cin), .X (n_8));
  sky130_fd_sc_hd__clkbuf_1 g76(.A (A[1]), .X (n_7));
  sky130_fd_sc_hd__buf_1 g75(.A (B[1]), .X (n_6));
  sky130_fd_sc_hd__nand2_2 g183__2346(.A (n_9), .B (n_5), .Y (Cout));
  sky130_fd_sc_hd__nand4_1 g184__1666(.A (n_2), .B (n_3), .C (n_8), .D
       (n_4), .Y (n_5));
  sky130_fd_sc_hd__nor2_1 g185__7410(.A (n_0), .B (n_1), .Y (n_4));
  sky130_fd_sc_hd__xor2_1 g186__6417(.A (B[3]), .B (A[3]), .X (n_3));
  sky130_fd_sc_hd__xor2_1 g189__5477(.A (n_6), .B (n_7), .X (n_2));
...
module skip4_107(A, B, Cin, S, Cout);
  ...
  full_adder_95 FA3(.A (A[2]), .B (B[2]), .Cin (C[1]), .S (S[2]), .Cout
       (C[2]));
  full_adder_94 FA4(.A (n_9), .B (n_6), .Cin (C[2]), .S (S[3]), .Cout
       (C[3]));
  sky130_fd_sc_hd__inv_2 g74(.A (C[3]), .Y (n_10));
  sky130_fd_sc_hd__clkbuf_1 g75(.A (A[3]), .X (n_9));
  sky130_fd_sc_hd__clkbuf_1 g77(.A (B[0]), .X (n_8));
  ...
  sky130_fd_sc_hd__xnor2_1 g156__6260(.A (n_7), .B (n_8), .Y (n_2));
...
module skip4_105(A, B, Cin, S, Cout);
  ...
  full_adder_86 FA4(.A (A[3]), .B (B[3]), .Cin (C[2]), .S (S[3]), .Cout
       (C[3]));
  sky130_fd_sc_hd__nand2_4 g152__8428(.A (n_0), .B (n_6), .Y (Cout));
  sky130_fd_sc_hd__nand2_1 g153__5526(.A (Cin), .B (n_5), .Y (n_6));
  sky130_fd_sc_hd__nor4_1 g154__6783(.A (n_3), .B (n_4), .C (n_2), .D
       (n_1), .Y (n_5));
  sky130_fd_sc_hd__xnor2_1 g155__3680(.A (A[1]), .B (B[1]), .Y (n_4));
  sky130_fd_sc_hd__xnor2_1 g156__1617(.A (A[0]), .B (B[0]), .Y (n_3));
  sky130_fd_sc_hd__xnor2_1 g157__2802(.A (A[2]), .B (B[2]), .Y (n_2));
  sky130_fd_sc_hd__xnor2_1 g158__1705(.A (A[3]), .B (B[3]), .Y (n_1));
...
module skip4_104(A, B, Cin, S, Cout);
  ...
  full_adder_82 FA4(.A (A[3]), .B (B[3]), .Cin (C[2]), .S (S[3]), .Cout
       (C[3]));
  sky130_fd_sc_hd__clkbuf_1 g74(.A (Cin), .X (n_7));
  sky130_fd_sc_hd__nand2_4 g152__3680(.A (n_0), .B (n_6), .Y (Cout));
  sky130_fd_sc_hd__nand2_1 g153__1617(.A (n_7), .B (n_5), .Y (n_6));
...
module full_adder_81(A, B, Cin, S, Cout);
  ...
  wire A, B, Cin;
  wire S, Cout;
  wire UNCONNECTED, n_1, n_2, n_3, n_4, n_9;
  sky130_fd_sc_hd__nand2_2 g122__6131(.A (n_4), .B (n_2), .Y (Cout));
  sky130_fd_sc_hd__nand2_2 g124__1881(.A (Cin), .B (n_3), .Y (n_4));
  sky130_fd_sc_hd__or2_0 g125__5115(.A (A), .B (B), .X (n_3));
  sky130_fd_sc_hd__nand2_1 g126__7482(.A (B), .B (n_1), .Y (n_2));
  sky130_fd_sc_hd__buf_1 g127(.A (A), .X (n_1));
  sky130_fd_sc_hd__fa_1 g129__4733(.A (B), .B (n_1), .CIN (n_9), .COUT
       (UNCONNECTED), .SUM (S));
...
module full_adder_79(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g126__5477(.A (B), .B (A), .Y (n_2));
  sky130_fd_sc_hd__buf_1 g127(.A (Cin), .X (n_1));
...
module skip4_103(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g158__3680(.A (Cin), .B (n_5), .Y (n_6));
...
module full_adder_72(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__clkbuf_1 fopt130(.A (Cin), .X (n_1));
...
module full_adder_71(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_4 g124__5107(.A (n_7), .B (n_8), .Y (S));
  sky130_fd_sc_hd__nand2_2 g125__6260(.A (n_15), .B (n_5), .Y (n_8));
  ...
  sky130_fd_sc_hd__or2_0 g130__6783(.A (A), .B (B), .X (n_3));
  sky130_fd_sc_hd__nand2_1 g131__3680(.A (B), .B (A), .Y (n_2));
...
module full_adder_70(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_8 g124__2802(.A (n_6), .B (n_0), .Y (S));
  ...
  sky130_fd_sc_hd__nand2_1 g131__6131(.A (B), .B (A), .Y (n_2));
  sky130_fd_sc_hd__inv_2 fopt(.A (Cin), .Y (n_1));
  sky130_fd_sc_hd__nand2b_2 g2__1881(.A_N (n_4), .B (Cin), .Y (n_0));
endmodule
...
module carry_skip4_32bits(A, B, Cin, S, Cout);
  ...
  wire n_64, n_65, n_66;
  skip4 CSKIP1(.A ({n_0, n_63, n_58, n_1}), .B ({n_66, n_5, n_62,
       n_61}), .Cin (n_65), .S (S[3:0]), .Cout (C[0]));
  skip4_107 \skip_loop[1].CSKIP2 (.A ({n_14, n_11, n_7, n_2}), .B
       ({n_35, n_4, n_46, n_39}), .Cin (C[0]), .S (S[7:4]), .Cout
       (C[1]));
  skip4_106 \skip_loop[2].CSKIP2 (.A ({n_30, n_52, n_21, n_18}), .B
       ({n_12, n_10, n_8, n_22}), .Cin (C[1]), .S (S[11:8]), .Cout
       (C[2]));
  skip4_105 \skip_loop[3].CSKIP2 (.A ({n_49, n_44, n_40, n_34}), .B
       ({n_19, n_17, n_15, n_13}), .Cin (C[2]), .S (S[15:12]), .Cout
       (C[3]));
  skip4_104 \skip_loop[4].CSKIP2 (.A ({n_3, n_48, n_6, n_57}), .B
       ({n_29, n_26, n_23, n_20}), .Cin (C[3]), .S (S[19:16]), .Cout
       (C[4]));
  skip4_103 \skip_loop[5].CSKIP2 (.A ({n_16, n_27, n_32, n_41}), .B
       ({n_36, n_33, n_31, n_45}), .Cin (C[4]), .S (S[23:20]), .Cout
       (C[5]));
  skip4_102 \skip_loop[6].CSKIP2 (.A ({n_9, n_47, n_53, n_42}), .B
       ({n_51, n_43, n_55, n_38}), .Cin (C[5]), .S (S[27:24]), .Cout
       (C[6]));
  skip4_101 \skip_loop[7].CSKIP2 (.A ({n_28, n_56, n_60, n_25}), .B
       ({n_54, n_37, n_50, n_64}), .Cin (C[6]), .S (S[31:28]), .Cout
       (Cout));
  sky130_fd_sc_hd__inv_2 g37(.A (n_59), .Y (n_66));
  sky130_fd_sc_hd__clkinv_1 g61(.A (n_24), .Y (n_65));
  sky130_fd_sc_hd__buf_1 g15(.A (B[28]), .X (n_64));
  sky130_fd_sc_hd__clkbuf_1 g50(.A (A[2]), .X (n_63));
  sky130_fd_sc_hd__clkbuf_1 g17(.A (B[1]), .X (n_62));
  sky130_fd_sc_hd__buf_8 g14(.A (B[0]), .X (n_61));
  sky130_fd_sc_hd__clkbuf_1 g26(.A (A[29]), .X (n_60));
  sky130_fd_sc_hd__clkinv_2 g38(.A (B[3]), .Y (n_59));
  sky130_fd_sc_hd__clkbuf_1 g29(.A (A[1]), .X (n_58));
  sky130_fd_sc_hd__clkbuf_1 g28(.A (A[16]), .X (n_57));
  sky130_fd_sc_hd__clkbuf_1 g51(.A (A[30]), .X (n_56));
  sky130_fd_sc_hd__buf_1 g59(.A (B[25]), .X (n_55));
  sky130_fd_sc_hd__clkbuf_1 g30(.A (B[31]), .X (n_54));
  sky130_fd_sc_hd__buf_1 g40(.A (A[25]), .X (n_53));
  sky130_fd_sc_hd__clkbuf_1 g12(.A (A[10]), .X (n_52));
  sky130_fd_sc_hd__buf_1 g25(.A (B[27]), .X (n_51));
  sky130_fd_sc_hd__buf_1 g45(.A (B[29]), .X (n_50));
  sky130_fd_sc_hd__clkbuf_1 g41(.A (A[15]), .X (n_49));
  sky130_fd_sc_hd__clkbuf_1 g32(.A (A[18]), .X (n_48));
  sky130_fd_sc_hd__buf_1 g22(.A (A[26]), .X (n_47));
  sky130_fd_sc_hd__clkbuf_1 g6(.A (B[5]), .X (n_46));
  sky130_fd_sc_hd__buf_1 g20(.A (B[20]), .X (n_45));
  sky130_fd_sc_hd__clkbuf_1 g33(.A (A[14]), .X (n_44));
  sky130_fd_sc_hd__buf_1 g46(.A (B[26]), .X (n_43));
  sky130_fd_sc_hd__buf_1 g21(.A (A[24]), .X (n_42));
  sky130_fd_sc_hd__clkbuf_1 g42(.A (A[20]), .X (n_41));
  sky130_fd_sc_hd__clkbuf_1 g44(.A (A[13]), .X (n_40));
  sky130_fd_sc_hd__clkbuf_1 g56(.A (B[4]), .X (n_39));
  sky130_fd_sc_hd__buf_1 g57(.A (B[24]), .X (n_38));
  sky130_fd_sc_hd__clkbuf_1 g55(.A (B[30]), .X (n_37));
  sky130_fd_sc_hd__buf_1 g39(.A (B[23]), .X (n_36));
  sky130_fd_sc_hd__clkbuf_1 g66(.A (B[7]), .X (n_35));
  sky130_fd_sc_hd__clkbuf_1 g54(.A (A[12]), .X (n_34));
  sky130_fd_sc_hd__buf_1 g7(.A (B[22]), .X (n_33));
  sky130_fd_sc_hd__clkbuf_1 g3(.A (A[21]), .X (n_32));
  sky130_fd_sc_hd__buf_1 g53(.A (B[21]), .X (n_31));
  sky130_fd_sc_hd__clkbuf_1 g13(.A (A[11]), .X (n_30));
  sky130_fd_sc_hd__clkbuf_1 g23(.A (B[19]), .X (n_29));
  sky130_fd_sc_hd__clkbuf_1 g16(.A (A[31]), .X (n_28));
  sky130_fd_sc_hd__clkbuf_1 g47(.A (A[22]), .X (n_27));
  sky130_fd_sc_hd__clkbuf_1 g52(.A (B[18]), .X (n_26));
  sky130_fd_sc_hd__clkbuf_1 g27(.A (A[28]), .X (n_25));
  sky130_fd_sc_hd__inv_4 g62(.A (Cin), .Y (n_24));
  sky130_fd_sc_hd__clkbuf_1 g8(.A (B[17]), .X (n_23));
  sky130_fd_sc_hd__clkbuf_1 g63(.A (B[8]), .X (n_22));
  sky130_fd_sc_hd__clkbuf_1 g36(.A (A[9]), .X (n_21));
  sky130_fd_sc_hd__clkbuf_1 g24(.A (B[16]), .X (n_20));
  sky130_fd_sc_hd__clkbuf_1 g9(.A (B[15]), .X (n_19));
  sky130_fd_sc_hd__clkbuf_1 g43(.A (A[8]), .X (n_18));
  sky130_fd_sc_hd__clkbuf_1 g4(.A (B[14]), .X (n_17));
  sky130_fd_sc_hd__clkbuf_1 g2(.A (A[23]), .X (n_16));
  sky130_fd_sc_hd__clkbuf_1 g19(.A (B[13]), .X (n_15));
  sky130_fd_sc_hd__clkbuf_1 g35(.A (A[7]), .X (n_14));
  sky130_fd_sc_hd__clkbuf_1 g1(.A (B[12]), .X (n_13));
  sky130_fd_sc_hd__clkbuf_1 g34(.A (B[11]), .X (n_12));
  sky130_fd_sc_hd__clkbuf_1 g48(.A (A[6]), .X (n_11));
  sky130_fd_sc_hd__clkbuf_1 g18(.A (B[10]), .X (n_10));
  sky130_fd_sc_hd__buf_1 g60(.A (A[27]), .X (n_9));
  sky130_fd_sc_hd__clkbuf_1 g67(.A (B[9]), .X (n_8));
  sky130_fd_sc_hd__clkbuf_1 g5(.A (A[5]), .X (n_7));
