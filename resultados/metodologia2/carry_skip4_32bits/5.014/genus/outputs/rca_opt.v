...
// Generated on: Apr  7 2025 17:27:58 -03 (Apr  7 2025 20:27:58 UTC)
...
module full_adder_99(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g127__5115(.A (B), .B (n_1), .Y (n_5));
...
module full_adder_98(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g124__6161(.A (Cin), .B (n_0), .Y (n_4));
...
module skip4(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand4_1 g184__1666(.A (n_2), .B (n_3), .C (Cin), .D
       (n_4), .Y (n_5));
...
module full_adder_97(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g127__3680(.A (B), .B (A), .Y (n_3));
...
module full_adder_95(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g127__6161(.A (B), .B (n_1), .Y (n_3));
  sky130_fd_sc_hd__clkbuf_1 g128(.A (Cin), .X (n_2));
  sky130_fd_sc_hd__buf_1 g129(.A (A), .X (n_1));
endmodule
...
module full_adder_94(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g127__7410(.A (B), .B (A), .Y (n_3));
  sky130_fd_sc_hd__clkbuf_1 g128(.A (Cin), .X (n_2));
endmodule
...
module skip4_106(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__xnor2_1 g156__5526(.A (A[0]), .B (n_6), .Y (n_2));
...
module full_adder_87(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_0 g126__1666(.A (A), .B (B), .X (n_4));
  sky130_fd_sc_hd__nand2_1 g127__7410(.A (B), .B (n_1), .Y (n_3));
  sky130_fd_sc_hd__clkbuf_1 g128(.A (Cin), .X (n_2));
  sky130_fd_sc_hd__buf_1 g129(.A (A), .X (n_1));
endmodule
...
module full_adder_85(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_0 g126__1881(.A (A), .B (B), .X (n_4));
  sky130_fd_sc_hd__nand2_1 g127__5115(.A (B), .B (A), .Y (n_3));
  sky130_fd_sc_hd__clkbuf_1 g128(.A (Cin), .X (n_2));
endmodule
...
module full_adder_81(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g126__7482(.A (B), .B (A), .Y (n_2));
  sky130_fd_sc_hd__fa_1 g129__4733(.A (B), .B (A), .CIN (Cin), .COUT
       (UNCONNECTED), .SUM (S));
endmodule
...
module full_adder_80(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g126__2883(.A (B), .B (A), .Y (n_3));
...
module carry_skip4_32bits(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__inv_2 g62(.A (Cin), .Y (n_24));
  ...
  sky130_fd_sc_hd__buf_6 g58(.A (A[0]), .X (n_1));
