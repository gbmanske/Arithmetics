...
// Generated on: Apr  7 2025 17:14:33 -03 (Apr  7 2025 20:14:33 UTC)
...
module skip4_107(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__clkbuf_1 g77(.A (A[0]), .X (n_8));
  ...
  sky130_fd_sc_hd__xnor2_1 g156__6260(.A (n_8), .B (n_7), .Y (n_2));
...
module skip4_106(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__xnor2_1 g156__5526(.A (n_6), .B (n_7), .Y (n_2));
...
module full_adder_83(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_0 g125__7410(.A (A), .B (B), .X (n_4));
...
module full_adder_82(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g126__8428(.A (B), .B (n_0), .Y (n_2));
...
module skip4_104(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__nand2_1 g153__6783(.A (n_6), .B (n_4), .Y (n_5));
...
module full_adder_81(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__or2_1 g125__6131(.A (A), .B (B), .X (n_3));
...
module skip4_102(A, B, Cin, S, Cout);
  ...
  sky130_fd_sc_hd__buf_2 g75(.A (Cin), .X (n_6));
  sky130_fd_sc_hd__nand2_2 g157__2802(.A (n_7), .B (n_5), .Y (Cout));
...
module full_adder_73(A, B, Cin, S, Cout);
  ...
  wire S, Cout;
  wire n_0, n_1, n_2, n_3, n_9;
  sky130_fd_sc_hd__nand2_2 g122__5115(.A (n_3), .B (n_1), .Y (Cout));
  sky130_fd_sc_hd__a2bb2o_4 g123__7482(.A1_N (n_0), .A2_N (n_9), .B1
       (n_0), .B2 (n_9), .X (S));
  sky130_fd_sc_hd__nand2_2 g124__4733(.A (Cin), .B (n_2), .Y (n_3));
