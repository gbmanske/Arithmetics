...
// Generated on: Mar 26 2025 17:01:02 -03 (Mar 26 2025 20:01:02 UTC)
...
module cla_16bits(A, B, Cin, S, Cout);
  ...
  propagate_i_86 \GENERATE_PROPAGATE[15].PROPAGATE (.Ai (n_33), .Bi
       (n_32), .Pi (P[15]));
  sky130_fd_sc_hd__inv_1 g21(.A (n_9), .Y (n_36));
  sky130_fd_sc_hd__inv_1 g3(.A (n_8), .Y (n_51));
  sky130_fd_sc_hd__inv_1 g31(.A (n_1), .Y (n_53));
  sky130_fd_sc_hd__inv_1 g7(.A (n_11), .Y (n_49));
  sky130_fd_sc_hd__inv_1 g33(.A (n_0), .Y (n_37));
  sky130_fd_sc_hd__inv_1 g63(.A (n_26), .Y (n_56));
  sky130_fd_sc_hd__inv_1 g35(.A (n_13), .Y (n_59));
  sky130_fd_sc_hd__inv_1 g17(.A (n_27), .Y (n_44));
  sky130_fd_sc_hd__inv_1 g37(.A (n_21), .Y (n_47));
  sky130_fd_sc_hd__inv_1 g59(.A (n_20), .Y (n_39));
  sky130_fd_sc_hd__inv_1 g39(.A (n_25), .Y (n_54));
  sky130_fd_sc_hd__inv_1 g9(.A (n_23), .Y (n_57));
  sky130_fd_sc_hd__inv_1 g19(.A (n_28), .Y (n_46));
  sky130_fd_sc_hd__inv_1 g41(.A (n_16), .Y (n_34));
  sky130_fd_sc_hd__inv_1 g43(.A (n_5), .Y (n_50));
  sky130_fd_sc_hd__inv_1 g15(.A (n_3), .Y (n_55));
  sky130_fd_sc_hd__inv_1 g61(.A (n_22), .Y (n_43));
  sky130_fd_sc_hd__inv_1 g23(.A (n_19), .Y (n_41));
  sky130_fd_sc_hd__inv_1 g47(.A (n_6), .Y (n_60));
  sky130_fd_sc_hd__inv_1 g11(.A (n_12), .Y (n_48));
  sky130_fd_sc_hd__inv_1 g49(.A (n_7), .Y (n_40));
  sky130_fd_sc_hd__inv_1 g1(.A (n_24), .Y (n_61));
  sky130_fd_sc_hd__inv_1 g25(.A (n_30), .Y (n_35));
  sky130_fd_sc_hd__inv_1 g51(.A (n_2), .Y (n_62));
  sky130_fd_sc_hd__inv_1 g53(.A (n_4), .Y (n_45));
  sky130_fd_sc_hd__inv_1 g27(.A (n_17), .Y (n_32));
  sky130_fd_sc_hd__inv_1 g55(.A (n_18), .Y (n_33));
  sky130_fd_sc_hd__inv_1 g13(.A (n_14), .Y (n_58));
  sky130_fd_sc_hd__inv_1 g57(.A (n_15), .Y (n_42));
  sky130_fd_sc_hd__inv_1 g5(.A (n_31), .Y (n_63));
  sky130_fd_sc_hd__inv_1 g29(.A (n_29), .Y (n_38));
  sky130_fd_sc_hd__inv_1 g45(.A (n_10), .Y (n_52));
  sky130_fd_sc_hd__clkinv_1 g6(.A (A[0]), .Y (n_31));
  sky130_fd_sc_hd__inv_2 g26(.A (A[14]), .Y (n_30));
  sky130_fd_sc_hd__clkinv_1 g30(.A (B[12]), .Y (n_29));
  sky130_fd_sc_hd__clkinv_1 g20(.A (B[8]), .Y (n_28));
  sky130_fd_sc_hd__clkinv_1 g18(.A (B[9]), .Y (n_27));
  sky130_fd_sc_hd__clkinv_1 g64(.A (B[3]), .Y (n_26));
  sky130_fd_sc_hd__clkinv_1 g40(.A (B[4]), .Y (n_25));
  sky130_fd_sc_hd__clkinv_1 g2(.A (A[1]), .Y (n_24));
  sky130_fd_sc_hd__clkinv_1 g10(.A (A[3]), .Y (n_23));
  sky130_fd_sc_hd__clkinv_1 g62(.A (A[10]), .Y (n_22));
  sky130_fd_sc_hd__clkinv_1 g38(.A (A[8]), .Y (n_21));
  sky130_fd_sc_hd__clkinv_1 g60(.A (A[12]), .Y (n_20));
  sky130_fd_sc_hd__clkinv_1 g24(.A (A[11]), .Y (n_19));
  sky130_fd_sc_hd__inv_2 g56(.A (A[15]), .Y (n_18));
  sky130_fd_sc_hd__inv_2 g28(.A (B[15]), .Y (n_17));
  sky130_fd_sc_hd__inv_2 g42(.A (B[14]), .Y (n_16));
  sky130_fd_sc_hd__clkinv_1 g58(.A (B[10]), .Y (n_15));
  sky130_fd_sc_hd__clkinv_1 g14(.A (B[2]), .Y (n_14));
  sky130_fd_sc_hd__clkinv_1 g36(.A (A[2]), .Y (n_13));
  sky130_fd_sc_hd__clkinv_1 g12(.A (B[7]), .Y (n_12));
  sky130_fd_sc_hd__clkinv_1 g8(.A (A[7]), .Y (n_11));
  sky130_fd_sc_hd__clkinv_1 g46(.A (B[5]), .Y (n_10));
  sky130_fd_sc_hd__clkinv_1 g22(.A (B[13]), .Y (n_9));
  sky130_fd_sc_hd__clkinv_1 g4(.A (A[6]), .Y (n_8));
  sky130_fd_sc_hd__clkinv_1 g50(.A (B[11]), .Y (n_7));
  sky130_fd_sc_hd__clkinv_1 g48(.A (B[1]), .Y (n_6));
  sky130_fd_sc_hd__clkinv_1 g44(.A (B[6]), .Y (n_5));
  sky130_fd_sc_hd__clkinv_1 g54(.A (A[9]), .Y (n_4));
  sky130_fd_sc_hd__clkinv_1 g16(.A (A[4]), .Y (n_3));
  sky130_fd_sc_hd__clkinv_1 g52(.A (B[0]), .Y (n_2));
  sky130_fd_sc_hd__clkinv_1 g32(.A (A[5]), .Y (n_1));
  sky130_fd_sc_hd__clkinv_1 g34(.A (A[13]), .Y (n_0));
