...
// Generated on: Mar 31 2025 17:25:38 -03 (Mar 31 2025 20:25:38 UTC)
...
module cla_16bits(A, B, Cin, S, Cout);
  ...
  carry_90 C6(.Gi (G0600), .Pi (P0600), .Cin (Cin), .Ci (C[6]));
  ...
  carry_93 C11(.Gi (G1100), .Pi (P1100), .Cin (Cin), .Ci (C[11]));
  carry_89 C12(.Gi (G1200), .Pi (P1200), .Cin (Cin), .Ci (C[12]));
  carry_88 C13(.Gi (G1300), .Pi (P1300), .Cin (Cin), .Ci (C[13]));
  ...
  soutput_148 S3(.Pi (P[3]), .Cant (C[2]), .Si (S[3]));
  ...
  soutput_143 S9(.Pi (P[9]), .Cant (C[8]), .Si (S[9]));
  soutput_143 S10(.Pi (P[10]), .Cant (C[9]), .Si (S[10]));
  soutput_139 S11(.Pi (P[11]), .Cant (C[10]), .Si (S[11]));
  soutput_144 S12(.Pi (P[12]), .Cant (C[11]), .Si (S[12]));
  soutput_143 S13(.Pi (P[13]), .Cant (C[12]), .Si (S[13]));
  soutput_139 S14(.Pi (P[14]), .Cant (C[13]), .Si (S[14]));
